...
package de.bwl.bwfla.management;
...
public class NodeManager {
    ...
    private ManagedThreadFactory workerThreadFactory;
    ...
    protected AbstractEaasComponent createComponentInstance(ComponentConfiguration configuration, String componentId) throws BWFLAException {
        try {
            ...
            final Runnable cleanup = new CleanupTrigger(component, componentsConfig.getTimeout());
            scheduler.schedule(cleanup, componentsConfig.getWarmupTimeout().toMillis(), TimeUnit.MILLISECONDS);
