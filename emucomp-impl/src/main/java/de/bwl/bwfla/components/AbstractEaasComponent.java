...
public abstract class AbstractEaasComponent implements ClusterComponent {
    ...
    private Map<String, IConnector> controlConnectors = new ConcurrentHashMap<>();
