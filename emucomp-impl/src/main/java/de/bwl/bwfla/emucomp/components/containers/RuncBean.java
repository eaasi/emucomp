...
import de.bwl.bwfla.emucomp.ContainerConfiguration;
import de.bwl.bwfla.emucomp.DeprecatedProcessRunner;
import de.bwl.bwfla.emucomp.EmulatorUtils;
import de.bwl.bwfla.emucomp.OciContainerConfiguration;
...
public class RuncBean extends ContainerBean {
    @Inject
    @ConfigProperty(name = "components.binary.runc")
    private String runc;
    int port = -1;
    @Inject
    @ConfigProperty(name = "components.xpra.ports")
