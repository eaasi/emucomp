...
public class MachineResource {
    ...
    public int attachMedium(@PathParam("componentId") String componentId, @XmlMimeType("application/octet-stream") DataHandler data, String mediaType) throws BWFLAException {
        final EmulatorComponent emul = nodeManager.getComponentById(componentId, EmulatorComponent.class);
