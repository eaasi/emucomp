...
public class BWFLAGuacamoleTunnelServlet extends HttpServlet {
    ...
    protected GuacTunnel getGuacamoleTunnel(HttpServletRequest request) throws GuacamoleResourceNotFoundException {
        final String componentId = this.getComponentId(request);
        return this.getGuacamoleTunnel(componentId);
    }

    protected GuacTunnel getGuacamoleTunnel(String componentId) throws GuacamoleResourceNotFoundException {
        final GuacamoleConnector connector = this.getGuacamoleConnector(componentId);
        final GuacTunnel tunnel = connector.getTunnel();
        if (tunnel == null)
    ...
    protected GuacTunnel newGuacamoleTunnel(String componentId)
    ...
    protected void doWrite(HttpServletRequest request, HttpServletResponse response) throws GuacamoleException {
        ...
        final GuacTunnel tunnel = this.getGuacamoleTunnel(request);
        if (!tunnel.isOpen())
