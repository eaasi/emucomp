...
import de.bwl.bwfla.emucomp.services.container.types.*;

import static de.bwl.bwfla.emucomp.services.container.types.Container.Filesystem.*;
...
{	
	public static ContainerHelper getContainerHelper(String dev, Container.Filesystem fsys)
	{	
