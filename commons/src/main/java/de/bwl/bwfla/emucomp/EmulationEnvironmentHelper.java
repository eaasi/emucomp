...
import static de.bwl.bwfla.emucomp.Drive.DriveType.CDROM;
import static de.bwl.bwfla.emucomp.Drive.DriveType.FLOPPY;
...
public class EmulationEnvironmentHelper {
	...
	public static MachineConfiguration clean(final MachineConfiguration original) {
		...
		for (Drive d : env.getDrive()) {
			...
			if (d.getType() == CDROM || d.getType() == FLOPPY) {
...
//	}
	...
	public static String addBinding(MachineConfiguration env, String url, Binding.AccessType accessType) {
		if (env == null) {
	...
	public static int registerDrive(MachineConfiguration env, String binding, String path, DriveType driveType) {
		// construct URL
		String subres = "";
		if (path != null)
