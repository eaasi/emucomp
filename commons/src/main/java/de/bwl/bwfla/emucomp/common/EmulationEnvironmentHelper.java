...
public class EmulationEnvironmentHelper {
	...
	public static Drive findEmptyDrive(MachineConfiguration env, DriveType type) {
	...
	public static MachineConfiguration clean(final MachineConfiguration original, boolean cleanRemovableDrives) {
		...
		for (Drive d : env.getDrive()) {
			...
			if (d.getType() == DriveType.CDROM || d.getType() == DriveType.FLOPPY) {
	...
	public static Environment registerDataSource(Environment env, String ref, DriveType type)
