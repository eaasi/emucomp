...
import de.bwl.bwfla.emucomp.data.ImageInformation;
...
public class EmulatorUtils {
    ...
    private static final String curlProxySo = ConfigProvider.getConfig().getValue("emucomp.curl_proxy", String.class);
