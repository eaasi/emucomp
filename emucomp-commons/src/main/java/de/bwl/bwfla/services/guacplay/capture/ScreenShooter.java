...
import de.bwl.bwfla.services.guacplay.GuacDefs.ExtOpCode;
import de.bwl.bwfla.services.guacplay.GuacDefs.OpCode;
import de.bwl.bwfla.services.guacplay.graphics.OffscreenCanvas;
import de.bwl.bwfla.services.guacplay.net.IGuacInterceptor;
import de.bwl.bwfla.services.guacplay.protocol.BufferedMessageProcessor;
import de.bwl.bwfla.services.guacplay.protocol.InstructionBuilder;
import de.bwl.bwfla.services.guacplay.protocol.handler.*;
import de.bwl.bwfla.services.guacplay.util.CharArrayWrapper;
import de.bwl.bwfla.services.guacplay.util.StopWatch;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import java.io.IOException;

import static de.bwl.bwfla.services.guacplay.GuacDefs.SourceType.INTERNAL;
import static de.bwl.bwfla.services.guacplay.GuacDefs.SourceType.SERVER;
...
public class ScreenShooter implements IGuacInterceptor {
    ...
    public void takeScreenshot() {
        msgProcessor.postMessage(INTERNAL, stopwatch.timems(), SCREENSHOT_MESSAGE);
    }
    ...
    public boolean onServerMessage(CharArrayWrapper message) throws Exception {
        ...
        if (msgProcessor.postMessage(SERVER, stopwatch.timems(), message) == 1)
            msgWorker.wakeup();
