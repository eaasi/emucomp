package de.bwl.bwfla.util;

import de.bwl.bwfla.config.bindings.Binding;
import de.bwl.bwfla.exceptions.BWFLAException;
import de.bwl.bwfla.models.QcowOptions;
import de.bwl.bwfla.services.security.MachineTokenProvider;
...
public class EmulatorUtils {
    ...
    public static String connectBinding(Binding resource, Path resourceDir, XmountOptions xmountOpts)
    ...
    private static Path handleToPath(String handle, Path tempPath) throws Exception {
        ...
        Path cowFile = Files.createTempFile(tempPath, "cow-", ".qcow2");
...
//		}
    ...
    public void createNewImg(Path destFile, String bs, long sizeMb) throws BWFLAException {
